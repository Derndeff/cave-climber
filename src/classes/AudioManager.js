...
import { RunAudio, DeathAudio, WallJumpAudio, SlideAudio, WindAudio } from 'audio';
...
class AudioManager {
  ...
  constructor() {
    ...
    this.sounds.set(4, new Sound(this.audioListener, WindAudio, true)); // slide sound

    this.sounds.get(2).audio.detune = 0;
    this.sounds.get(3).audio.detune = -1400;
